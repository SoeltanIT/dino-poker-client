...
import { MyReferralGroupSettingsProps } from './types'

export default function MyReferralGroupSettings({ lang, locale, initialData }: MyReferralGroupSettingsProps) {
              ...
              {isLoading ? (
                ...
                <div className='space-y-3'>
                  <div className='bg-app-background-primary rounded-lg p-4 border border-app-neutral300 space-y-2'>
                    ...
                    <div className='flex justify-between items-center'>
                      <div className='text-sm'>{lang?.common?.userShare}</div>
                      <div className='text-sm'>{settings.user_share}%</div>
                    </div>

                    <div className='flex justify-between items-center'>
                      <div className='text-sm'>{lang?.common?.affiliateShare}</div>
                ...
                <>
                  <div className='p-8 text-center flex flex-col gap-3 items-center'>
                    ...
                    />
                    <p className='text-app-text-color text-sm'>{lang?.common?.noSettings}.</p>
                  </div>
                </>
              )}
            </div>
