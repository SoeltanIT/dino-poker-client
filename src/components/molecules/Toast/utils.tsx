...
export const wrapperClasses: Record<RequiredToastProps['type'], string> = {
  ...
  error: 'toast-error text-app-text-color text-[10px] font-[325]'
}

export const iconClasses: Record<RequiredToastProps['type'], string> = {
  info: 'bg-blue-500 text-app-text-color',
  success: 'bg-green-500 text-app-text-color',
  warning: 'bg-orange-500 text-app-text-color',
  error: 'toast-error'
}

export const closeButtonClasses =
  'w-4 h-4 mx-3 items-center justify-center text-app-neutral500 dark:text-gray-200 hover:text-gray-900 rounded-md focus:ring-2 focus:ring-gray-300 inline-flex dark:hover:text-app-text-color'
